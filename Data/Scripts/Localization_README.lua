--[[
	...
	5. Look for texts that are very similar and procedurally generated.
	...
	5. To disable translation of a specific text, add <disable> in front of it.
	   That text will appear with the default language instead.
	6. The "Max Glyphs" column serves as instruction for translators. Specifying
	   a maximum number of glyphs helps texts fit correctly in the UI.
	7. The "Explanation" column tells translators about the context of a text.
	   Many texts don't need an explanation or it is easy to infer. However,
	   it's very common that game-specific terms needs to be consistent across
